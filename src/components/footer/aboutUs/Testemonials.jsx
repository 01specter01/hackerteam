    ...
    <div className="testimonials">
      <Card className="card">
        ...
        <Card.Body className="card">
          <p className="card">
            The graph displays how our cutomers have raited our service:
          </p>
          <br />
          <img
            className="card"
      ...
      <article>
        ...
        <Card className="card">
          <Card.Header>Rating from Customer: Allan Turing</Card.Header>
          <Card.Body>
            <blockquote className="blockquote mb-0">
              <h4>new approach to teaching</h4>
              <p>
                I learned just a bit of react, but all I learned was concise
                information Date of experience: July 1, 2020
              </p>
            </blockquote>
          </Card.Body>
        </Card>
        <Card className="card next">
          ...
          <Card.Body>
            <blockquote className="blockquote mb-0">
              ...
              <p>
                Very bad if you have no clue how to code. HackerUnited is a
                medioca place to learn. Date of experience: July 20, 2020
              </p>
            </blockquote>
          </Card.Body>
        </Card>
        <Card className="card">
          ...
          <Card.Body>
            <blockquote className="blockquote mb-0">
              ...
              <p>Thumbs up from me. Date of experience: July 1, 2020</p>
            </blockquote>
          </Card.Body>
        </Card>
        <Card className="card">
          <Card.Header>Rating from Customer: Maya Deloris</Card.Header>
          <Card.Body>
            <blockquote className="blockquote mb-0">
              <h4>One place with all the information you need</h4>
              <p>
                I liked how the information was collected and shared all in one
                place. Date of experience: May 15, 2020
              </p>
            </blockquote>
          </Card.Body>
        </Card>
        <Card className="card">
          <Card.Header>Rating from Customer: Archiles Magademdon</Card.Header>
          <Card.Body>
            <blockquote className="blockquote mb-0">
              <h4>Not as engaging as hoped</h4>
              <p>
                I would have liked a more interresting site, somethimes it was
                boring to spend time here. Date of experience: May 27, 2020
              </p>
            </blockquote>
          </Card.Body>
        </Card>
